...
class Infortis_Fortis_Block_Adminhtml_System_Config_Form_Field_Tex extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	/**
     * Add texture preview
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		//$texUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . Mage::helper('fortis')->getTexPath();
